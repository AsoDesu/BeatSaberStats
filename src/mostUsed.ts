//
//  This script generates Most Used Blocks, also takes over 10 seconds to run with 1,022 maps
//
...
fs.writeFileSync("out/mostUsed.json", JSON.stringify({ total: totalNotes, percents }, null, 2));
